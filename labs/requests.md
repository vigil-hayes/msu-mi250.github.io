...
Accept the terms of service, and then TMDB will then present you with a form about that app that asks you for a lot of information. Fill it the form -- give your app a name, provide a description, etc. You can use this website (<http://mi250.info>) for the required website and Holden Hall for the address and phone number (234 Wilson Rd, East Lansing, MI 48825; phone number: +15173535912). Make it a personal app.  
