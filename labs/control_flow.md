...
Today, you'll turn in screenshots of your code working (programs running in PowerShell or Terminal) and the .py files you edited for today's exercises. Turn everything in on D2L, under Assignments -> Week 2: Lab: Control Flow.
