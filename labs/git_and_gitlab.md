...
**NOTE:** remember to practice pair programming for this section! Get everything working on one person's computer first before you start trying things on the second person's computer. This will make things easier in the long run, I promise!
